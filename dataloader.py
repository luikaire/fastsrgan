...
class NumpyImagesDataset(Dataset):
    ...
    def __init__(self, numpy_paths,numpy_paths_lq, lr_image_size, scale_factor):
        self.numpy_paths = numpy_paths
        self.numpy_paths_lq = numpy_paths_lq
    ...
    def __getitem__(self, idx):
        ...
        image_lq = np.load(self.numpy_paths_lq[idx], mmap_mode="c")
        _, h, w = image.shape
